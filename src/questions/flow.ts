...
const core: Record<string, Question> = {
  ...
  dbSafety: {
    id: 'dbSafety',
    type: 'confirm',
    summary: 'Confirm destructive SQL/migrations',
    message: 'Require explicit confirmation before running destructive SQL or database migrations?',
    recommended: true,
    policyDefault: true,
    when: (a) => a.projectType !== 'frontend' && !!a.database,
  },
  structure: {
    id: 'structure',
    type: 'select',
