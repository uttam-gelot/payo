...
export function helpText(): string {
  return [
    ...
    '',
    'Usage:',
    '  npx @uge/payo            Start the interactive questionnaire',
    '  npx @uge/payo --version  Print the version and exit',
    '  npx @uge/payo --help     Show this help and exit',
    '',
    'Payo interviews you about your stack and conventions, then writes each',
    "AI tool's guidance file in its native format (CLAUDE.md, .cursorrules,",
    'AGENTS.md, …). Interrupted? Just re-run — your answers are saved.',
    '',
    'Environment variables:',
    '  PAYO_CONCURRENCY       Max parallel agent runs (default: 4)',
    '  PAYO_RETRIES           Extra attempts after a failed run (default: 1)',
    '  PAYO_AGENT_TIMEOUT_MS  Per-run agent timeout in ms (default: 120000)',
