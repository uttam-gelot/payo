...
`composer.json`, `*.csproj`, lockfiles, tool configs, and the folder layout — to figure out
your stack across **TypeScript/JavaScript, Python, Go, Rust, PHP, and C#**, then pre-fills the questionnaire
